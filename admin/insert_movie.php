...
<!--                        </div>-->
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="description" id="description"
                                      placeholder="Enter Description" cols="10" rows="10"></textarea></div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="raiting" id="raiting"
                                   placeholder="Enter Raiting"/>
                        </div>
                        <br>
                        <div class="form-group text-center">
                            <button type="submit" class="btn btn-primary btn-lg" name="insert" id="insert"
                                    value="insert">Insert
                            </button>
                ...
                <?php } else {
                    ...
                    if ($sql->insert('movie', $data)) {
                        echo "<h1>{$_POST['name']} inserted succesfully</h1>";
                        echo '<a style="padding:10px; background-color: #00abf5; text-decoration: none; boreder-radius: 5px;" href="admin/redindex.php">Back to Home</a>';
                    } else {
                        echo "<h1>{$_POST['name']} failed to  insert</h1>";
                    }
                }
                ?>
            </div>
